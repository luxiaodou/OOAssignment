...
public class Taxi extends Thread {
	...
	protected Node moveTo = null;
	protected DriverState driverState;
	protected int credit;
	protected Order way2Customer;
	protected Order realOrder;
	protected int count = 0;
	protected Boolean tracked;
	protected Direction headfor;
	...
	protected void seeLight() throws InterruptedException {
